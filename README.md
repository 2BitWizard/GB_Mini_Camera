...
- The M74VHC1GU04DFT1G-L22038 signal inverter is becoming hard to source in 2024 so it is recommended to switch to a MC74VHC1GU04DF1G/M74VHC1GU04DFT1G ou any other substitutes (you can use the Digikey engine to search for equivalent parts). The SC-88 package version is quite hard to find on Aliexpress.
