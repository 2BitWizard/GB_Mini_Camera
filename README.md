...
## Showcase
![](/Showcase_2.png)
The FRAM came without dot to indicate pin 1 so I used the notch to orient it.

![](/Showcase_3.png)
I've ordered the long board to fit it in a regular camera shell. It can be broken at the "neck" to fit a shorter shell.
